...
<template lang="pug">
  div
    keep-alive
      kalix-table(:isShowToolBar="isShowToolBar" bizKey="myinvolvedprocesshistory" title='我参与的流程列表'
...
<script type="text/ecmascript-6">
  ...
  import {MyInvolvedURL, WorkflowButtonList} from '../config.toml'
  ...
  export default {
    name: 'kalix-oa-myinvolvedprocesshistory',
    activated() {
