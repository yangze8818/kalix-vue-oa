...
<template lang="pug">
  div
    keep-alive
      kalix-table(bizKey='carApply' title='公务用车申请列表' v-bind:targetURL='targetURL'
...
<script type="text/ecmascript-6">
  ...
  import {CarApplyURL, CarApplyStartURL} from '../config.toml'
  // import {registerComponent} from '@/api/register'
  // import {workflowBtnList, registerComp, customTableTool} from '@/views/oa/comp'
  import {workflowBtnList, customTableTool} from '../../../views/oa/comp'
