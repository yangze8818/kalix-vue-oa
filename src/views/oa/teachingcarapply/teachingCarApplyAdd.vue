    ...
    div.el-form.kalix-form-table(slot="dialogFormSlot")
      ...
      div.s-flex
        ...
        div.s-flex_item(style="margin-left:-1px")
          div.s-flex
            div.s-flex_item
              kalix-datetimepicker(v-model="formModel.beginDate" placeholder="选择开始时间" style="margin-left:1px;width:100%")
            div(style="line-height:32px") 至
            div.s-flex_item
              kalix-datetimepicker(v-model="formModel.endDate" placeholder="选择结束时间" style="width:100%")
      ...
      div.s-flex
        ...
        // el-form-item.s-flex_item.kalix-form-table-td(label="是否市内用车" prop="city" v-bind:label-width="labelWidth")
          div(style="text-align:center")
            el-switch.s-flex_item(v-model="formModel.city" active-text="是" inactive-text="否")
        el-form-item.s-flex_item.kalix-form-table-td(label="用车情况" prop="city" v-bind:label-width="labelWidth")
          div(style="text-align:center")
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    created() {
      this.orgNameOptions = JSON.parse(this.$KalixCatch.get(`${'UserOrgs'.toUpperCase()}-KEY`))
    },
    methods: {
      onOrgIdChange(item) {
