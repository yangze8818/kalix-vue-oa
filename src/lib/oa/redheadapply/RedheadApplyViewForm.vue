  ...
  methods: {
    ...
    getBizData() {
      ...
      if (this.bizId) {
        ...
        this.axios.get(bizDataUrl, params).then((response) => {
    ...
    onPreview() {
      if (this.bizId) {
        window.open(this.$KalixGlobalConfig.baseURL + '/camel/servlet/download?beanname=RedheadApply&id=' + this.bizId + '&filetype=html')
      } else {
        if (this.formModel.id) {
          window.open(this.$KalixGlobalConfig.baseURL + '/camel/servlet/download?beanname=RedheadApply&id=' + this.formModel.id + '&filetype=html')
        } else {
