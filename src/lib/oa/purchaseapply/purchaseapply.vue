...
<template lang="pug">
  div
    keep-alive
      kalix-table(bizKey='purchaseApply' title='采购申请列表' v-bind:targetURL='targetURL'
...
<script type="text/ecmascript-6">
  ...
  import {PurchaseApplyURL, PurchaseApplyStartURL} from '../config.toml'
