...
<template lang="pug">
  div
    keep-alive
      kalix-table(bizKey='recruitApply' title='用人申请列表' v-bind:targetURL='targetURL'
...
<script type="text/ecmascript-6">
  ...
  import {RecruitApplyURL, RecruitApplyStartURL} from '../config.toml'
