...
<script type="text/ecmascript-6">
  ...
  // import {TempApplyURL, TempApplyComponent, TempApplyStartURL} from '../config.toml'
  import {TempApplyURL, TempApplyStartURL} from '../config.toml'
