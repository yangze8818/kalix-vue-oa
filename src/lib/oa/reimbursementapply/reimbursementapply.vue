...
<template lang="pug">
  div
    keep-alive
      kalix-table(bizKey='reimbursementApply' title='报销申请列表' v-bind:targetURL='targetURL'
...
<script type="text/ecmascript-6">
  ...
  import {ReimbursementApplyURL, ReimbursementApplyStartURL} from '../config.toml'
  ...
  export default {
    name: 'kalix-oa-reimbursementapply',
    data() {
      return {
        isFixedColumn: true,
