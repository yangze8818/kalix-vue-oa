...
<script type="text/ecmascript-6">
  ...
  // import {SealApplyURL, SealApplyComponent, SealApplyStartURL} from '../config.toml'
  import {SealApplyURL, SealApplyStartURL} from '../config.toml'
