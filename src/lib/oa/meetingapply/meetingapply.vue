...
<template lang="pug">
  div
    keep-alive
      kalix-table(bizKey='meetapply' title='会议申请列表'
...
<script type="text/ecmascript-6">
  ...
  // import {MeetingApplyURL, MeetingApplyComponent, MeetingApplyStartURL} from '../config.toml'
  import {MeetingApplyURL, MeetingApplyStartURL} from '../config.toml'
  ...
  import {workflowBtnList, customTableTool} from '../comp/config'
