<template lang="pug">
  div
    keep-alive
      kalix-table(bizKey='evectionApply' title='出差申请列表' v-bind:targetURL='targetURL'
...
<script type="text/ecmascript-6">
  ...
  import {EvectionApplyURL, EvectionApplyStartURL} from '../config.toml'
